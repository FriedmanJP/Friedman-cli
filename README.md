...
Macroeconometric analysis from the terminal. A Julia CLI wrapping [MacroEconometricModels.jl](https://github.com/FriedmanJP/MacroEconometricModels.jl) (v0.7.2).
...
As of CLI v0.9.1 (MacroEconometricModels 0.7.2) 95 of 377 leaves are plot-capable.
