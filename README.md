...
- **`.jld2`** — native MacroEconometricModels.jl `save_model`/`load_model` (JLD2-backed,
  ...
  registry — **56 types** at MacroEconometricModels 0.8.0, essentially every estimator the
...
As of CLI v0.9.2 (MacroEconometricModels 0.8.0) 113 of 410 leaves are plot-capable.
