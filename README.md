...
- **`.jld2`** — native MacroEconometricModels.jl `save_model`/`load_model` (JLD2-backed,
  ...
  registry — **73 types** at MacroEconometricModels 0.9.0, essentially every estimator the
...
As of CLI v0.11.0 (MacroEconometricModels 0.9.0) 142 of 449 leaves are plot-capable.
