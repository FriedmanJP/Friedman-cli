...
As of CLI v0.11.0 (MacroEconometricModels 0.9.0) 142 of 449 leaves are plot-capable (144 of 453 on the v0.12.0 line — `estimate svar`/`estimate svec` add plot flags, `model reproduce` does not).
