...
├── forecast     aparch | arch | arima | bvar | cgarch | dynamic | egarch | evaluate clark-west | evaluate combine | evaluate dm | evaluate encompassing | evaluate metrics | evaluate mincer-zarnowitz | favar | fiegarch | figarch | garch | garch-midas | gdfm | gjr-garch | igarch | lp | setar | star | static | sv | var | vecm
...
├── predict     aparch | arch | arima | bvar | cgarch | dynamic | egarch | favar | fiegarch | figarch | garch | garch-midas | gdfm | gjr-garch | igarch | logit | mlogit | ologit | oprobit | piv | plogit | pprobit | preg | probit | reg | static | sv | var | vecm
├── residuals     aparch | arch | arima | bvar | cgarch | dynamic | egarch | favar | fiegarch | figarch | garch | garch-midas | gdfm | gjr-garch | igarch | logit | mlogit | ologit | oprobit | piv | plogit | pprobit | preg | probit | reg | static | sv | var | vecm
...
Total: 18 top-level commands, 346 leaves (from registry).
```
...
- [`forecast`](generated/forecast.md) — 28 leaves
...
- [`predict`](generated/predict.md) — 29 leaves
- [`residuals`](generated/residuals.md) — 29 leaves
