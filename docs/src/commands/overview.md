...
├── data     balance | describe | diagnose | dropna | filter | fix | import | keeprows | list | load | transform | validate
...
Total: 20 top-level commands, 454 leaves (from registry).
```
...
- [`data`](generated/data.md) — 12 leaves
