...
├── estimate     3sls | aparch | arch | arfima | arima | bekk | bvar | ccc | cgarch | dcc | dynamic | egarch | elastic-net | fastica | favar | fiegarch | figarch | garch | garch-midas | gdfm | gjr-garch | gmm | heckman | igarch | iv | lasso | logit | lp | ml | mlogit | ologit | oprobit | piv | plogit | pprobit | preg | probit | pvar | reg | ridge | robust | sdfm | smm | static | sur | sv | tobit | truncreg | var | vecm
...
Total: 17 top-level commands, 275 leaves (from registry).
```
...
- [`estimate`](generated/estimate.md) — 50 leaves
