...
├── forecast     aparch | arch | arfima | arima | bvar | cgarch | dynamic | egarch | evaluate clark-west | evaluate combine | evaluate dm | evaluate encompassing | evaluate metrics | evaluate mincer-zarnowitz | favar | fiegarch | figarch | garch | garch-midas | gdfm | gjr-garch | igarch | lp | midas | setar | star | static | sv | var | vecm
...
├── predict     3sls | aparch | arch | arfima | arima | bvar | cgarch | dynamic | egarch | favar | fiegarch | figarch | garch | garch-midas | gdfm | gjr-garch | igarch | logit | mlogit | ologit | oprobit | piv | plogit | pprobit | preg | probit | reg | static | sur | sv | var | vecm
├── residuals     3sls | aparch | arch | arfima | arima | bvar | cgarch | dynamic | egarch | favar | fiegarch | figarch | garch | garch-midas | gdfm | gjr-garch | igarch | logit | mlogit | ologit | oprobit | piv | plogit | pprobit | preg | probit | reg | static | sur | sv | var | vecm
...
Total: 18 top-level commands, 354 leaves (from registry).
```
...
- [`estimate`](generated/estimate.md) — 66 leaves
- [`fevd`](generated/fevd.md) — 7 leaves
- [`filter`](generated/filter.md) — 6 leaves
- [`forecast`](generated/forecast.md) — 30 leaves
...
- [`predict`](generated/predict.md) — 32 leaves
- [`residuals`](generated/residuals.md) — 32 leaves
