...
├── policy     counterfactual bvar | counterfactual lp | counterfactual var | effects bvar | effects lp | effects sign | effects var
...
Total: 19 top-level commands, 394 leaves (from registry).
```
...
- [`policy`](generated/policy.md) — 7 leaves
