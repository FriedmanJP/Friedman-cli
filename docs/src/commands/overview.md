...
Total: 18 top-level commands, 294 leaves (from registry).
```
...
- [`estimate`](generated/estimate.md) — 60 leaves
...
- [`test`](generated/test.md) — 64 leaves
