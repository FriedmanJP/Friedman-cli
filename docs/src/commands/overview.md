...
├── estimate     3sls | aparch | arch | arfima | arima | bekk | bvar | ccc | cgarch | dcc | dynamic | egarch | elastic-net | fastica | favar | fiegarch | figarch | garch | garch-midas | gdfm | gjr-garch | gmm | igarch | iv | lasso | logit | lp | ml | mlogit | ologit | oprobit | piv | plogit | pprobit | preg | probit | pvar | reg | ridge | robust | sdfm | smm | static | sur | sv | tobit | var | vecm
...
- [`estimate`](generated/estimate.md) — 48 leaves
