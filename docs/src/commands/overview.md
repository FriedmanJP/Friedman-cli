...
├── forecast     aparch | arch | arfima | arima | bvar | cgarch | dynamic | egarch | evaluate clark-west | evaluate combine | evaluate dm | evaluate encompassing | evaluate metrics | evaluate mincer-zarnowitz | favar | fiegarch | figarch | garch | garch-midas | gdfm | gjr-garch | igarch | lp | midas | ms | ms-ar | setar | star | static | sv | var | vecm
...
├── predict     3sls | aparch | arch | arfima | arima | bvar | cgarch | dynamic | egarch | favar | fiegarch | figarch | garch | garch-midas | gdfm | gjr-garch | igarch | logit | mlogit | ms | ms-ar | nbreg | ologit | oprobit | piv | plogit | poisson | pprobit | preg | probit | reg | statespace | static | sur | sv | var | vecm
├── residuals     3sls | aparch | arch | arfima | arima | bvar | cgarch | dynamic | egarch | favar | fiegarch | figarch | garch | garch-midas | gdfm | gjr-garch | igarch | logit | mlogit | ms | ms-ar | nbreg | ologit | oprobit | piv | plogit | poisson | pprobit | preg | probit | reg | setar | star | statespace | static | sur | sv | var | vecm
...
Total: 18 top-level commands, 372 leaves (from registry).
```
...
- [`dsge`](generated/dsge.md) — 36 leaves
- [`estimate`](generated/estimate.md) — 69 leaves
- [`fevd`](generated/fevd.md) — 7 leaves
- [`filter`](generated/filter.md) — 6 leaves
- [`forecast`](generated/forecast.md) — 32 leaves
...
- [`predict`](generated/predict.md) — 37 leaves
- [`residuals`](generated/residuals.md) — 39 leaves
