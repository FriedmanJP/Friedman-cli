...
├── predict     3sls | aparch | arch | arfima | arima | bvar | cgarch | dynamic | egarch | favar | fiegarch | figarch | garch | garch-midas | gdfm | gjr-garch | igarch | logit | mlogit | ms | ms-ar | ologit | oprobit | piv | plogit | pprobit | preg | probit | reg | statespace | static | sur | sv | var | vecm
...
Total: 18 top-level commands, 365 leaves (from registry).
```
...
- [`estimate`](generated/estimate.md) — 67 leaves
...
- [`predict`](generated/predict.md) — 35 leaves
