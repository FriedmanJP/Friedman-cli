...
_friedman() {
  ...
  case "${words[1]}" in
    ...
    estimate) COMPREPLY=( $(compgen -W "arch arima bvar dynamic egarch fastica favar garch gdfm gjr-garch gmm iv logit lp ml mlogit ologit oprobit piv plogit pprobit preg probit pvar reg sdfm smm static sv var vecm" -- "$cur") ) ;;
