...
_friedman() {
  ...
  case "${words[1]}" in
    ...
    predict) COMPREPLY=( $(compgen -W "3sls aparch arch arfima arima bvar cgarch dynamic egarch favar fiegarch figarch garch garch-midas gdfm gjr-garch igarch logit mlogit ms ms-ar ologit oprobit piv plogit pprobit preg probit reg statespace static sur sv var vecm" -- "$cur") ) ;;
    residuals) COMPREPLY=( $(compgen -W "3sls aparch arch arfima arima bvar cgarch dynamic egarch favar fiegarch figarch garch garch-midas gdfm gjr-garch igarch logit mlogit ms ms-ar ologit oprobit piv plogit pprobit preg probit reg setar star statespace static sur sv var vecm" -- "$cur") ) ;;
