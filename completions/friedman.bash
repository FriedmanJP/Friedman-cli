...
_friedman() {
  ...
  case "${words[1]}" in
    ...
    predict) COMPREPLY=( $(compgen -W "aparch arch arfima arima bvar cgarch dynamic egarch favar fiegarch figarch garch garch-midas gdfm gjr-garch igarch logit mlogit ologit oprobit piv plogit pprobit preg probit reg static sv var vecm" -- "$cur") ) ;;
    residuals) COMPREPLY=( $(compgen -W "aparch arch arfima arima bvar cgarch dynamic egarch favar fiegarch figarch garch garch-midas gdfm gjr-garch igarch logit mlogit ologit oprobit piv plogit pprobit preg probit reg static sv var vecm" -- "$cur") ) ;;
