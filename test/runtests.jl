...
@testset "estimate smm command structure" begin
    ...
    # 50 primary leaves + 1 snake alias (gjr_garch) = 51 keys (C044; +6 GARCH variants C064a, +arfima C068, +3 MGARCH C064b, +5 penalized/robust/tobit C067a, +truncreg/heckman C067b)
    @test length(est_node.subcmds) == 51
    @test haskey(est_node.subcmds, "smm")
